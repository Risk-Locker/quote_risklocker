...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        rate_limit_login_attempts=_bounded_int("RATE_LIMIT_LOGIN_ATTEMPTS", 20, 1, 1000),
        rate_limit_login_window_seconds=_bounded_int("RATE_LIMIT_LOGIN_WINDOW_SECONDS", 900, 1, 86_400),
        rate_limit_login_block_seconds=_bounded_int("RATE_LIMIT_LOGIN_BLOCK_SECONDS", 300, 1, 86_400),
        rate_limit_upload_attempts=_bounded_int("RATE_LIMIT_UPLOAD_ATTEMPTS", 500, 1, 100_000),
        rate_limit_upload_window_seconds=_bounded_int("RATE_LIMIT_UPLOAD_WINDOW_SECONDS", 3_600, 1, 86_400),
        rate_limit_preview_attempts=_bounded_int("RATE_LIMIT_PREVIEW_ATTEMPTS", 300, 1, 100_000),
        rate_limit_preview_window_seconds=_bounded_int("RATE_LIMIT_PREVIEW_WINDOW_SECONDS", 60, 1, 86_400),
        rate_limit_generation_attempts=_bounded_int("RATE_LIMIT_GENERATION_ATTEMPTS", 500, 1, 100_000),
        rate_limit_generation_window_seconds=_bounded_int("RATE_LIMIT_GENERATION_WINDOW_SECONDS", 3_600, 1, 86_400),
        rate_limit_download_attempts=_bounded_int("RATE_LIMIT_DOWNLOAD_ATTEMPTS", 500, 1, 100_000),
        rate_limit_download_window_seconds=_bounded_int("RATE_LIMIT_DOWNLOAD_WINDOW_SECONDS", 60, 1, 86_400),
        rate_limit_import_attempts=_bounded_int("RATE_LIMIT_IMPORT_ATTEMPTS", 50, 1, 10_000),
